          ...
          <div className={"introduction " + themename}>
            ...
            <div className="introduction_datacontainer">
              <h4>
                ...
                <span className="different">Aakanksha Gaikwad </span> and I am
                from{" "}
                ...
                . Then I joined web development course by{" "}
                <span className="different">Function up</span> a coding school.
              </h4>
